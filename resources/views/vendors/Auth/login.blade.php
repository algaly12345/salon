                ...
                <div class="card border-grey border-lighten-3 m-0">
                    <div class="card-header border-0">
                        ...
                        <h6 class="card-subtitle line-on-side text-muted text-center font-small-3 pt-2">
                            <span>الدخول للوحة التحكم المتجر  </span>
                        </h6>
                    </div>
                    @include('vendors.includes.alerts.errors')
                    @include('vendors.includes.alerts.success')
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form-horizontal form-simple" action="{{route('vendors.login')}}" method="post"
                                  novalidate>
                                @csrf
