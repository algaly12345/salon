                ...
                <li class="nav-item">
                    <a class="navbar-brand" href="index.html">
                        <img class="brand-logo" alt="modern admin logo"
                             src="{{asset('assets/admin/images/logo/logo.jpg')}}">
                        <h3 class="brand-text">سلال نجد</h3>
                    </a>
                </li>
        ...
        <div class="navbar-container content">
            <div class="collapse navbar-collapse" id="navbar-mobile">
                ...
                <span class="mr-1">مرجبا
                  <span
                      class="user-name text-bold-700">  احمد شوقي الامين</span>
                </span>
                            <span class="avatar avatar-online">
                  <img  style="height: 35px;" src="https://scontent.fruh4-5.fna.fbcdn.net/v/t1.6435-9/185554808_1173484346415709_744770032305029638_n.jpg?_nc_cat=100&ccb=1-3&_nc_sid=09cbfe&_nc_ohc=10lr_aUTbJQAX_Ry8fM&_nc_ht=scontent.fruh4-5.fna&oh=8fe8561756bc85329a5f7badfc76b8e2&oe=60DEACA7" alt="avatar"><i></i></span>
                        </a>
