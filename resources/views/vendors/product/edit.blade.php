                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"> تعديل - {{$product -> productName}}
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('vendors.products.update',$product -> Id)}}"
                                              method="POST"
                                                                    ...
                                                                    @if($categories && $categories -> count() > 0)
                                                                        @foreach($categories as $category)
                                                                            <option
                                                                                ...
                                                                                @if($product -> subCategoryId == $category -> subCategoryId  )  selected @endif
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 ">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="productOldPrice"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 ">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="productNewPrice"
                                                                   value="{{$product -> productNewPrice}}"
                                                                   class="form-control"
